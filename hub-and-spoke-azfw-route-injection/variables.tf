...
variable "hub_azfw_subnet" { type = string }
variable "hub_azfw_subnet_prefix" { type = string }
variable "hub_ri_subnet" { type = string }
variable "hub_ri_subnet_prefix" { type = string }
