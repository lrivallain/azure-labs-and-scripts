...
resource "azurerm_route_server_bgp_connection" "hub_rs_bgp_connection" {
  name            = "hub-rs-bgp-connection"
  route_server_id = azurerm_route_server.hub_route_server.id
  peer_asn        = var.hub_nva_vm_asn
  peer_ip         = azurerm_network_interface.hub_nva_vm.private_ip_address
}
